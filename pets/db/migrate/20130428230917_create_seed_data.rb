class CreateSeedData < ActiveRecord::Migration
  def up
    bob_address = create_address('123 Street Name', 'Minneapolis', 'MN', '12345')
    create_doctor('Bob Doctor', 'Harvard', 5, bob_address)
    
    susan_address = create_address('456 Street Name', 'Minneapolis', 'MN', '01257')
    create_doctor('Susan Doctor', 'MIT', 4, susan_address)
    
    john_address = create_address('105 Street Name', 'Minneapolis', 'MN', '76412')
